...
public final class LocalizationManager: ObservableObject {
    ...
    public func t(_ key: String) -> String {
        ...
        case "Unified Sample": return isVi ? "Mẫu Chuẩn" : "Unified Sample"
        case "Dual Stacked": return isVi ? "Xếp Tầng" : "Dual Stacked"
        case "Compact Shield": return isVi ? "Khiên Gọn" : "Compact Shield"
        case "Separate Items": return isVi ? "Tách Rời" : "Separate Items"
        case "Recommended": return isVi ? "Đề xuất" : "Recommended"
        case "Free Space": return isVi ? "Còn trống" : "Free Space"
        case "Used %": return isVi ? "% Đã dùng" : "Used %"
